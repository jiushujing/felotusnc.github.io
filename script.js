document.addEventListener('DOMContentLoaded', () => {
    ...
    setupPageTransition(sidebarApiLink, apiSettingsPage, openSidebar);
            ...
            try {
                if (currentApiType === 'openai') {
                    ...
                    const filteredModels = data.models
                        .filter(m => m.name.includes('gemini') && m.supportedGenerationMethods.includes('generateContent') && !m.name.includes('vision'))
